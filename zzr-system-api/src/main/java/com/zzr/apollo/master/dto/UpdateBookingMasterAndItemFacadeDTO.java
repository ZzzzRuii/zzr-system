 ...
 * @since 2022/9/15 17:45
 */
@Data
@ToString
@ApiModel(value = "UpdateBookingMasterAndItemFacadeDTO对象", description = "订单合并")
public class UpdateBookingMasterAndItemFacadeDTO implements Serializable {
