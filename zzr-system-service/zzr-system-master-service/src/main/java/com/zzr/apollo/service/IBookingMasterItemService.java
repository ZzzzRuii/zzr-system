 ...
 */
public interface IBookingMasterItemService extends IZzrService<BookingMasterItemDO> {
    /**
     * 根据主键 查询详情
     *
     * @param id
     * @return
     */
    BookingMasterItemDO detail(Long id);
     ...
     * @return
     */
    Page<BookingMasterItemVO> selectPage(Query query, QueryBookingMasterItemDTO bookingMasterItem);
     ...
     * @return
     */
    List<BookingMasterItemVO> selectByOrderId(Long orderId);
     ...
     * @return
     */
    Boolean update(UpdateBookingMasterItemDTO bookingMasterItem, Long id);
     ...
     * @return
     */
    BookingMasterItemDO create(CreateBookingMasterItemDTO bookingMasterItem);
     ...
     * @param itemDO
     */
    void calculateAmount(BookingMasterItemDO itemDO);
}
