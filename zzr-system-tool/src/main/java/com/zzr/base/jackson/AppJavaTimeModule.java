...
import com.zzr.base.utils.DateTimeUtil;
 ...
 * @author ZhouZhiRui
 * @version 1.0
 * @since 2022/12/28 10:47
 */
public class AppJavaTimeModule extends SimpleModule {
    public static final AppJavaTimeModule INSTANCE = new AppJavaTimeModule();

    public AppJavaTimeModule() {
